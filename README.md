...
<div align="justify">Buat database baru dengan nama db_persediaan, kemudian klik Import database.</div>
<br>

Buka web e-laboratory pada browser dengan url:
```sh
http://localhost/e-laboratory
```

Untuk User pengguna ada 3 kriteria 
- Admin
- User
- Manajer

Login pertama gunanakan Username dan password ---> admin
## License
