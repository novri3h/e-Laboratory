...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | e-Laboratory</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Betta Integrated Digital System">
    <meta name="author" content="Tri Hartono" />
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="?module=home" class="logo">e-Laboratory</a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2023 - <a href="http://bit.ly/M-UMKM">Nadhif Studio</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
